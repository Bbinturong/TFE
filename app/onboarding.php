    ...
    <img class='spiro-logo' src="assets/img/spiro-logo.png" alt="Spiro Logo">
        ...
        <p> Un nouveau moyen de rencontrer de nouvelles personnes et d'engager une conversation instatanément.  </p>

        <h3> Dit moi ton <e>Nom</e></h3>
        <form method="post" action="">

    <span class='input-style'>
    <input type="text" name="name" value="" placeholder="Pierre">    
    </span>
    <p>  et partons à la rencontre d'autre personne ! </p>
