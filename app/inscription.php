...
if (!empty($_POST) ) {
     ...
     if (empty($name)) {
       $error["name_empty"] = "Alors tu n'as pas de nom ?";
     } else { require "add_db.php"; header("location:onboarding1.php"); }
}
...
<body>
    ...
    <img class='spiro-logo' src="assets/img/spiro-logo.png" alt="Spiro Logo">
        <h2> Bienvenue  sur  Spiro</h2>

        <h3> Dis moi le <em>Nom</em> avec lequel tu veux te faire connaître</h3>
    ...
    } else { echo "<p> et partons à la rencontre d'autres personnes ! </p>";} ?>
