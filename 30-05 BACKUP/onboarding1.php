...
<body>
    ...
    <div class='onboarding ob0'>
        ...
        <g>
            <polyline fill="none" stroke="#8781bd" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" points="4.75,22.396 19.396,36.833 43.25,11.167  "/>
        </g>
        </svg>
    ...
    <div class='onboarding ob3 disappear-ob'>
        ...
        <svg class='svg' version="1.1" id="gotoob4"  x="0px" y="0px"  width="40px" height="40px" viewBox="0 0 48 48">
        <g>
            <polyline fill="none" stroke="#8781bd" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" points="4.75,22.396 19.396,36.833 43.25,11.167  "/>
        </g>
        </svg>
